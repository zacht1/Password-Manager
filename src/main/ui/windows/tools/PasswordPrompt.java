...
// Class copied from https://tips4java.wordpress.com/2009/11/29/text-prompt/
// Rob Camick
 ...
 *  class construction.
 */
public class PasswordPrompt extends JLabel implements FocusListener, DocumentListener {
    ...
    public PasswordPrompt(String text, JTextComponent component) {
        this(text, component, Show.ALWAYS);
    }

    public PasswordPrompt(String text, JTextComponent component, Show show) {
        ...
        setForeground(new Color(100, 105, 121));
        setBorder(new EmptyBorder(new Insets(5,3,5,9)));
    ...
    public void changeAlpha(int alpha) {
        int newAlpha = (alpha > 255) ? 255 : ((alpha < 0) ? 0 : alpha);
        ...
        Color withAlpha = new Color(red, green, blue, newAlpha);
